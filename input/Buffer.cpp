...
std::ostream& RSSD::Core::Input::operator <<(
	std::ostream &stream,
	const Buffer &buffer)
{
...
template <>
Buffer& RSSD::Core::Input::operator << <string_t>(Buffer &buffer, string_t &value)
{
...
template <>
Buffer& RSSD::Core::Input::operator << <Buffer>(Buffer &lhs, Buffer &rhs)
{
	lhs = rhs;
