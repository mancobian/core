...
{
public:
	typedef RSSD::Core::Pattern::Manager<RSSD::Network::BasicClient::Pointer> BaseManager;
	typedef BaseManager::ItemList BasicClient_l;
...
public:
	BasicClientManager(
		...
		const string_t &udp_broadcast_address,
...
protected:
	...
	uint32_t _tcp_port,
		...
		_udp_broadcast_port,
		_num_clients;
	string_t _udp_broadcast_address;
	boost::mutex _mutex;
